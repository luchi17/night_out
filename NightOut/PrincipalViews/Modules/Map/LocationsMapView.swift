        ...
        .sheet(isPresented: $showingDetail) {
            if let location = selectedLocation {
                LocationDetailSheet(
                    ...
                    .presentationDragIndicator(.visible) // Mostramos el indicador de arrastre
                }
        }
        .onChange(of: selectedLocation, {
            showingDetail = selectedLocation != nil // Mostrar la sheet cuando se selecciona una discoteca
        })
